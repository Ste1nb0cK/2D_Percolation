...
Eigen::ArrayXXi fill(int L, double p, int seed);
/*Función
...
Eigen::ArrayXXi
Path(const Eigen::Ref<Eigen::ArrayXXi> I, int L, int scanning,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
Eigen::ArrayXXi clouster_matrix(const Eigen::Ref<Eigen::ArrayXXi> I, int L) {
