...
plt.title("Tiempo de computo. p=0.3")
plt.xlabel("Tamaño de la matriz")
plt.ylabel("Tiempo (s)")
plt.legend()
plt.grid()
plt.savefig('Computing_time_p03.png')
...
plt.title("Tiempo de computo. p=0.6")
plt.xlabel("Tamaño de la matriz")
plt.ylabel("Tiempo (s)")
plt.legend()
plt.grid()
plt.savefig('Computing_time_p06.png')
...
plt.title("Tiempo de computo. p=0.8")
plt.xlabel("Tamaño de la matriz")
plt.ylabel("Tiempo (s)")
plt.legend()
plt.grid()
plt.savefig('Computing_time_p08.png')
