...
TEST_CASE("Percolation test", "[index_matrix]", "[Size_clouster]", "[Percolation]", "[clouster_matrix]"){
  ...
  REQUIRE(Percolation(A2, 100)==0);
  REQUIRE(Size_clouster(A2, 100)==0);

  REQUIRE(Percolation(A3, 200)==0);
  REQUIRE(Size_clouster(A3, 200)==0);

  REQUIRE(Percolation(A4, 10)==1);
  REQUIRE(Size_clouster(A4, 10)==100);

  REQUIRE(Percolation(A5, 100)==1);
  REQUIRE(Size_clouster(A5, 100)==10000);

  REQUIRE(Percolation(A6, 200)==1);
  REQUIRE(Size_clouster(A6, 200)==40000);

  REQUIRE(Percolation(A7, 30)==1);
  REQUIRE(Size_clouster(A7, 30)==60);

  REQUIRE(Percolation(A8, 30)==1);
  REQUIRE(Size_clouster(A8, 30)==60);

  REQUIRE(Percolation(A10, 30)==1);
